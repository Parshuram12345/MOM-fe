    ...
    <>
      <div className=" justify-around margin-left-3 width-75">
        <div className="d-flex align-center divider-margin">
          <div className="small-font-9 color-text-888888">Ashok rathi residence</div>
          <span className="d-flex align-center color-text-888888 small-font-9">
            <FaGreaterThan />
          </span>
          <span className="color-text">New MOM</span>
        </div>
        <div className="font-size-18 font-w-500 divider-margin">Create a MOM</div>
        <hr />
        <div className="divider-margin">
          <div className="d-flex justify-between align-center">
            <div className="d-flex justify-between align-center width-25">
              ...
              <div className="d-flex align-center position-relative"> 
                <DatePicker className="border-df bg-color-fa padding-5 border-radius-4" 
                value={momdate} onChange={(selectdate)=>dateFormater(selectdate)} 
          ...
          { dateerror && <small style={{ color: "red" }}>date is required</small>}
         { categoryerror && <small style={{ color: "red" }}>category is required</small>}
          </div>
          </div>
        <div className="d-flex-col">
          <label className="label-text">Share with (add more email ID as required):</label>
        ...
        { pointserror && <small style={{ color: "red" }}>write something here</small>}
        <button
