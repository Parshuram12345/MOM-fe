...
// import { sidenavLinkArray } from "../../Constants/sidenavLinkArray";
...
//             (curElem) =>
//               curElem.visible && (
//                 <div className={curElem.label === "My Projects" ? styles.sidenavLinkActive : styles.sidenavLinkStyle} onClick={() => goToPage(curElem.navigable, curElem.towards)}>
