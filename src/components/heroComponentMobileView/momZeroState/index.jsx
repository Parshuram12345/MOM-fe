...
function MomZeroState() {
    ...
    const [email, setEmail] = useState("dikshant@1996gmail.com")
       ...
       <div className='d-flex justify-around width-50 align-center'>
                ...
                <div className='d-flex-col divider-margin'>
                    ...
                    <div className='d-flex align-center border-df bg-color-fa padding-1'>
                            <input type="email" className='email-field border-df border-radius-25 padding-5' value={email} onChange={(e) => setEmail(e.target.value)}  placeholder='dikshant@1996gmail.com'/><i className='x icon'></i>
                        </div>
                </div>
                <div className='d-flex-col divider-margin'>
                ...
                <div className='d-flex-col justify-around divider-margin'>
                    ...
                    <textarea rows="8" cols="50" className='padding-5' placeholder="write something here"></textarea>
                </div>
