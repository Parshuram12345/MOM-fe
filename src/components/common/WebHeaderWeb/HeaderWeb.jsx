      ...
      <div className="lmsweb-header" style={{ height: "10vh" }}>
        <div className="d-flex" style={{height: "100%"}}>
          ...
          <div className="d-flex align-items-center" style={{ marginLeft: "5rem" }}>
            <div className={path.pathname === "/lead" ? "headerLinks-active" : "headerLinks"} onClick={() => goToNav("lead")}>
              Manage Leads
            </div>
            <div className={path.pathname === "/buy-leads" ? "headerLinks-active" : "headerLinks"} onClick={() => goToNav("buy-leads")}>
              Buy Leads
            </div>
            <div className={path.pathname === "/3dLanding" || path.pathname === "/3dFinal" || path.pathname === "/3dUploadCad" || path.pathname === "/3dSelectRoom" || path.pathname === "/3dMakePPT" || path.pathname === "/3dMakePPT/MakeOne" || path.pathname === "/3dMakePPT/UploadPdf" || path.pathname === "/3dCart" || path.pathname === "/3dCartHalf" ? "headerLinks-active" : "headerLinks"} onClick={() => goToNav("3dLanding")}>
             Book 3D Service
            </div>
            ...
            <a href =  "https://pro.idesign.market/community/" style={{textDecoration: "none", color: "black"}}>
          ...
          <div>
            <Dropdown style={{ display: "flex", alignItems: "center" }}>
              ...
              <Dropdown.Menu>
                ...
                <Dropdown.Item className="dropDownLinks" style={{ color: "#BE4C4C" }} onClick={goLogOut}>
