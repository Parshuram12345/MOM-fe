            ...
            <div className="d-flex" style={{ height: "30%", width: "100%" }}>
              ...
              <div className="reviewer d-flex">
                <div className="reviewer-name-section">
                  ...
                  <div className="reviewer-name mx-3" style={{ fontWeight: "bold", fontSize: '17px' }}>{review?.name}</div>
                  <div className="mx-3" style={{ color: 'grey', fontSize: '0.8rem' }}> Designer <span className='mx-1'>{convertDate(review?.date)}</span></div>

                </div>

                <div className="reviewer-rating" style={{ height: '25px', width: '47px', padding: '0px 9px', borderRadius: '0.4rem', margin: '0px -30px', backgroundColor: '#d9d9d9' }}> <MdStar style={{ color: "#49B7CF" }} /> <span style={{ color: "#49B7CF" }}>{review.rating}</span></div>

                <div className="report-reviewer" style={{ position: 'absolute', right: '30px', color: 'grey', fontSize: '0.8rem' }} role="button" onClick={openReportModal}><MdOutlineReport className="mx-1" style={{ fontSize: '1rem' }} />Report</div>
