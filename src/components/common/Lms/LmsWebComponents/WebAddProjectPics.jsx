...
export default function WebAddProjectPics() {
          ...
          <div>
            ...
            <div className="body d-flex justify-content-center" style={{ width: '76vw', height: '80vh' ,backgroundColor: '#ffffff',marginLeft:'20px' ,borderRadius: '10px'}} onClick={clickToAddImages}>
              <div className="" style={{
                ...
                <div style={{ fontSize: "28px", fontWeight: "600", margin: "40px 0 4px 0" ,fontWeight:'400'}}>Please upload your project photos</div>
                <div style={{ fontSize: "24px", fontWeight: "400",color: '#888888' }}> Accepted format jpeg,png </div>
              </div>
            </div>
            <div></div>
