...
export default function MobileViewYourReview() {
    return (
        <>
            <HeaderNav />
                ...
                <div className='d-flex flex-column'>
                    ...
                    <div style={{ marginLeft: '30px', alignItems: 'center' }}>
                        <p style={{
                            ...
                            fontSize: '18px',
                            lineHeight: '28px',
                        }}>We engaged Forefront after interviewing quite a few interior designers as we were not sure at the time how the renovation for our new 5 room BTO flat <br />should be We engaged Forefront after interviewing quite a few interior designers as we were not sure at the time how the renovation for our new 5 room <br />BTO flat should be </p>
