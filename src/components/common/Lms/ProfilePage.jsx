...
import ProfilePageWeb from "./LmsWebComponents/ProfilePageWeb";
    ...
    <>
      ...
      <div className="d-block d-md-none">
        ...
        <div className="profilePage-container">
          <section className="section_font profilePage">
            <Link style={{ textDecoration: "none", color: "black" }} to="/lead">
              <div className="container pro_style">
                ...
                <div className="profilePage-heading"> Profile Page</div>
              </div>
            </Link>
            <div>
              <div>
                ...
                <div className="anmes">
                  ...
                  <div>
                    <Link style={{ textDecoration: "none", color: "black" }} to="/myreviewspage">
                      <div className="d-flex justify-content-between div_name mt-1">
                        <div className="profilePage-myreviews">
